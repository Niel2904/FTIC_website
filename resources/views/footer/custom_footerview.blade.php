        ...
        <footer class="bg-extra-dark-green padding-20px-tb sm-padding-30px-tb" >
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-3 text-center text-lg-end text-white-2 padding-two-half-left">
                        <div class="text-medium margin-10px-bottom font-weight-600 alt-font border-width-5 border-bottom border-color-white">
                            Social Networks
                        </div>
                        <div class="row">
                            <p class="text-small text-white-2 margin-15px-bottom w-30 sm-w-10">
                                @innovate@fit.edu.ph
                            </p>
                            <p class="text-small text-white-2 margin-15px-bottom padding-fifteen-left sm-w-20">
                                FEU Tech Innovation Center
                            </p>
                        </div>
                        <div class="row">
                            <p class="text-small text-white-2 margin-15px-bottom w-20 sm-w-10">
