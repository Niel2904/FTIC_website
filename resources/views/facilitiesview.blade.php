...
<div class="containercol">
    ...
    <div class="column column-1">
        <img class="lounge" src="{{ asset('assets\css\imgs\lounge.jpg') }}" style="width:97.5%; align-items: center; object-fit: cover;border-radius: 5px;" alt="lounge">
        <h2 style="margin-bottom: 5px;font-size: 22px; margin-top:8px; margin-bottom:8px;">Lounge</h2>
        <p style="text-align: justify; width: 97.5%;font-size: 15px; margin-bottom: 15px">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.</p>
